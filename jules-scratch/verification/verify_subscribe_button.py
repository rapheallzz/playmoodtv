...
def run(playwright):
    ...
    # Wait for the subscribe/unsubscribe button to be visible
    subscribe_button = page.get_by_role("button", name=re.compile(r"Subscribe|Unsubscribe"))
    subscribe_button.wait_for(state='visible', timeout=10000)
