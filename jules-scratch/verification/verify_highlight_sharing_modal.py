...
def run(playwright):
    ...
    page.goto(f"http://localhost:5173/highlight/@{creator_name}/{encoded_highlight_id}")
    ...
    page.wait_for_selector('//*[text()="Share this Highlight"]')

    # Take a screenshot to verify the page loads correctly
    page.screenshot(path="jules-scratch/verification/verification_highlight_modal.png")
